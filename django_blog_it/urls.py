...
urlpatterns = [
    ...
    url(r'^dashboard/blog/$', PostList.as_view(), name='blog'),
    url(r'^dashboard/add/$', PostCreateView.as_view(), name='blog_add'),
    url(r'^dashboard/view/(?P<blog_slug>[-\w]+)/$', PostDetailView.as_view(), name='view_blog'),
    url(r'^dashboard/delete/(?P<blog_slug>[-\w]+)/$', PostDeleteView.as_view(), name='delete_blog'),
    url(r'^dashboard/edit/(?P<blog_slug>[-\w]+)/$', PostEditView.as_view(), name='edit_blog'),
