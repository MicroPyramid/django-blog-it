...
from .views import blog, blog_add, view_blog, delete_blog, edit_blog, categories, add_category, edit_category, \
    delete_category, bulk_actions_blog, bulk_actions_category
